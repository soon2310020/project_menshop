...
class CategoryController extends Controller
{
  ...
  public function index()
  {
    ...
    if (isset($_POST['name'])) {
        $params['query_additional'] = ' and name like ' ."'". $_POST['name']."'";
    }
    ...
    $params['total'] = $count_total;
      if (isset($_POST['name'])) {
          $count_total = $category_model->getTotalSearch();
          $params['total'] = $count_total;
      }
...
public  function reset()
{
  ...
  public function create()
  {
      ...
      if (isset($_POST['submit'])) {
          ...
          //check validate
          if (empty($name)) {
              $this->error = 'không được bỏ trống tên danh mục';
          ...
          if (empty($this->error)) {
              ...
              if ($avatar_files['error'] == 0) {
                  $dir_uploads = __DIR__ . '/../assets/uploads/categories_avatar';
...
//    lấy nội dung view create.php
  ...
  public function delete()
  {
    ...
    $id = $_GET['id'];
      ...
      {
          @unlink($dir_uploads . '/' . $category['avatar']);
      }
    $category_model = new Category();
